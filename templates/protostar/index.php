...
<?php
    ...
    $menu = $app->getMenu();
    if (!$user->id && $menu->getActive() == $menu->getDefault()) {
        $customHomepage = true;
    }
?>
<!DOCTYPE html>
...
<body class="<?php echo ($customHomepage) ? 'custom-home': 'site'?> <?php echo $option
	. ' view-' . $view
...
?>">
	...
	<div class="body" id="top">
		<div class="container<?php echo ($params->get('fluidContainer') ? '-fluid' : ''); echo ($customHomepage) ? ' custom-container': ''?>">
    	...
    	<footer class="footer" role="contentinfo">
    		<div class="container<?php echo ($params->get('fluidContainer') ? '-fluid' : ''); ?>">
    			...
    			<div class="footer-left">
    				Copyright &copy; <a href="/"><?php echo $sitename; ?></a> All Rights Reserved.
    			</div>
